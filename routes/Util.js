module.exports = function(app, auxiliares, logger) {
 ...
 *     
 */
app.get('/util/subscribir/:id', function (request, response) {
    var idArduino = request.params.id;
    var ip = request.body.valor;
    try {
...
app.get('/temporizador/:id', function (request, response) {
