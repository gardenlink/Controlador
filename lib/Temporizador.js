 ...
 *
 */
function Temporizador(config, logger, mailer, tweet,dispositivos) {
   ...
   temporizadores = config.temporizador;
  ...
  this._bombaprovider = new BombaProvider(this._logger, null, config);
