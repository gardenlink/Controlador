...
method.Avanzar = function(idMotor,callback) {
    ...
    this.arduinoService.callFunction("Avanzar",idMotor , function(data){
...
method.Detener = function(idMotor, callback)
{
   var objMotor = new MotorEntity();
   this.arduinoService.callFunction("Detener", idMotor, function(data){
       objMotor.Crear(idMotor, idMotor, 0,0, data.return_value,0);
       callback(objMotor.Objeto());
    });
};
...
{
   var objMotor = new MotorEntity();
   this.arduinoService.callFunction("Estado", idMotor, function(data){
       objMotor.Crear(idMotor, idMotor, 0,0, data.return_value,0);
       callback(objMotor.Objeto());
    });
};
